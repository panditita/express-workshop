...
const server = http.createServer(function (req, res) {
    ...
    if (req.url === '/') { //check the URL of the current request
        ...
        console.log("New request to Mentos page at " + Date())

        res.writeHead(200, { "Content-Type": "text/html" });
        res.write("<html><body><h1>This is MENTORS page.</h1></body></html>");
        res.write("<h3> some of our mentors are Irina, Ashleigh, Mozafar, Michael and Daniel</h3>");
        res.end();
    } else {
